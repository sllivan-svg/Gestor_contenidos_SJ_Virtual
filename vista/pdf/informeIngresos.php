...
("SELECT `id`, `id_estudiante`, `fecha` FROM `ingresos`");
$con->cerrarConexion();
include '../../librerias/plugins/FPDF/fpdf.php';
 class PDF extends FPDF {
     function Header()
     {
         ...
         $this->Cell(80);
         $this->Cell(30,10,"Reporte Ingresos APP",0,0,'C');
         $this->Ln(7);
         $this->Cell(80);
    ...
    $pdf->Cell(70,5,"Id Estudiante",1,0,'C',1);
    $pdf->Cell(70,5,"Fecha Ingreso",1,0,'C',1);
    $pdf->Ln();
    ...
    $pdf->Cell(70,5,$f[1],1,0,'L');
    $pdf->Cell(70,5,$f[2],1,0,'L');
    $pdf->Ln();
    endforeach;
